      ...
      //  height: Math.min(id_root.width, id_root.height)
        ...
        Canvas {
            ...
            onPaint: {
                ...
                context.beginPath()
                context.arc(id_speed.height / 2, id_speed.height / 2,
                            id_speed.height / 2 - id_speed.height * 0.05, 0,
                            Math.PI * 1.1, false)
                context.stroke()
                ...
                context.beginPath()
                context.arc(id_speed.height / 2, id_speed.height / 2,
                            id_speed.height / 2 - id_speed.height * 0.05,
                            Math.PI * 1.1, Math.PI * 1.4, false)
                context.stroke()
            }
        }
